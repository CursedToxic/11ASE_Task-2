...
|----|-----|-----------|
|Meets all specifications except the performance|60fps could have been quite easy to achieve by doing some optimisation|The player is able to sprint which was not defined although it is better that it is included|
|Weapon switching mechanism is quite efficient|Could have made the wave spawning mechanism better|Escape to pause is effective due to being common method|

**Alex**
|Plus|Minus|Implication|
|----|-----|-----------|
|Meets all requirements identified in his use cases|The enemy spawning freeze lowers performance|The walls were added make the map les boring to play on|
|Knife is one shot against the enemies|The wave system needs to be improved|The win screen is a nice addition|

From these peer reviews, I can gather that I need to improve on the enemy system, making it better performance. I will improve on these in future iterations which will be in PythonCode. In relation to the feedback given by Ronen, the weapon switching mechanism I need to give credit to Ursina Tutorials on YouTube, for most of the Player class. The feedback by Alex confirms that the enemy system needs improvement. The project also had time management issues that were not mentioned in their feedback. Overall, the program meets all but one of the requirments specified, this has been confirmed by the feedback of my peers.
